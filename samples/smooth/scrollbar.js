function oScrollbar() {
	...
	this.setCursorButton = function () {
		...
		gb.FillRectangle(1, 0, this.cursorw - 2, this.cursorh, setAlpha(g_colour_text, 50));
		DrawRectangle(gb, 1, 0, this.cursorw - 2 - 1, this.cursorh - 1, rectangle_outline);
		...
		gb.FillRectangle(1, 0, this.cursorw - 2, this.cursorh, setAlpha(g_colour_text, 100));
		DrawRectangle(gb, 1, 0, this.cursorw - 2 - 1, this.cursorh - 1, rectangle_outline);
		...
		gb.FillRectangle(1, 0, this.cursorw - 2, this.cursorh, setAlpha(g_colour_text, 150));
		DrawRectangle(gb, 1, 0, this.cursorw - 2 - 1, this.cursorh - 1, rectangle_outline);
